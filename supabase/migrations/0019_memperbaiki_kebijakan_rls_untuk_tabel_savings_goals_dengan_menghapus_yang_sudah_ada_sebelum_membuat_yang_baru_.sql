-- Hapus kebijakan yang sudah ada jika ada
DROP POLICY IF EXISTS "Admins can view all savings goals" ON public.savings_goals;
DROP POLICY IF EXISTS "Teachers can view their class savings goals" ON public.savings_goals;
DROP POLICY IF EXISTS "Parents can view their children's class savings goals" ON public.savings_goals;
